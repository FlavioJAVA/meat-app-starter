...
export class RestaurantsComponent implements OnInit {
	...
	ngOnInit() {
		...
		this.searchControl.valueChanges
			.debounceTime(500)//tempo em ms para enviar a requisição de pesquisa
			.distinctUntilChanged()//se for igual ao anterior não filtra
			//.do(searchTerm => console.log(`q=${searchTerm}`)) //imprimir no console
